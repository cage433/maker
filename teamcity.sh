...
java -Dbuild.number=$1 -Xmx4048M -XX:+CMSClassUnloadingEnabled -XX:MaxPermSize=650m -jar -Dsbt.log.noformat=true -Dhttp.nonProxyHosts=nexus.global.trafigura.com sbt/sbt-launch-0.11.1.jar ";clean; test; deploy-classpath; publish" || exit 1
bin/create_artifact.sh $1 || exit 2
