...
object Starling {
  ...
  lazy val pivot = project("pivot", List(maths), List(utils))
  lazy val pivotUtils = project("pivot.utils", pivot)
  ...
  lazy val curves = project("curves", List(guiapi), List(utils, quantity, daterange))
