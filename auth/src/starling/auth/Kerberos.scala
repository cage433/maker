...
//    System.setProperty("sun.security.krb5.debug", "true")
    ...
    System.setProperty("java.security.krb5.conf", url("/krb5.conf.auth").toExternalForm)
    System.setProperty("java.security.auth.login.config", url("/jaas.conf.auth").toExternalForm)
