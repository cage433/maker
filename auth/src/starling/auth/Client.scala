...
import javax.naming.{NamingEnumeration, NamingException, Context}
...
import starling.utils.{Utils, Log}
import starling.auth.ISVNSecurityLibrary.SEC_WINNT_AUTH_IDENTITY
...
object ClientLogin {
  ...
  def main(args: Array[String]) {
    ...
    val client = new Client("STARLING-TEST/dave-linux", subject)
