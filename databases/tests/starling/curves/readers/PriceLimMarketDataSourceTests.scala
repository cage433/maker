...
class PriceLimMarketDataSourceTests extends StarlingSpec with JMocker with TemporalSpec {
  ...
  "DataSource" should {
    "broadcast emails when data is missing" in {
      val (dataStore, broadcaster, dataSource) = create
