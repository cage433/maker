...
import starling.marketdata.{OilVolSurfaceDataKey, PriceDataKey}
...
object MarketDataXStreamConverters {
  ...
  val converters = List(priceDataKeyConverter, oilVolsDataKeyConverter, spreadStdDevDataKeyConverter)
}