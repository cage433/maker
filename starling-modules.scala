...
lazy val curves = project("curves") dependsOn (daterange, quantity, guiapi)
...
lazy val services = project("services").withResourceDirs("resources", "test-resources") dependsOn (curves, utils, loopyxl, titan, gui, titanReturnTypes, schemaevolution)
