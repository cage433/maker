...
trait PricingFixationHandler {
  /**
   * Indicates to the handler that a set of com.trafigura.edm.fpc.PricingFixation objects has arrived and is ready to be processed.
   ...
   */
  def onPricingFixation(props:MessageProperties, objs:List[com.trafigura.edm.fpc.PricingFixation], resultListener:MessageResultListener)
}
