...
import scala.collection.JavaConversions._
 ...
 class MonthAveragePricingSpec extends com.trafigura.edm.fpc.PricingSpec  {
...
var qpMonth:org.joda.time.LocalDate = null
  ...
  override def equals(o: Any) = o match {
    case r: AnyRef =>
        if (o.isInstanceOf[com.trafigura.edm.fpc.MonthAveragePricingSpec]) {
            val that = r.asInstanceOf[com.trafigura.edm.fpc.MonthAveragePricingSpec]
  ...
  override def canEqual(that : Any) = that.isInstanceOf[com.trafigura.edm.fpc.MonthAveragePricingSpec]
  ...
  override def toString = {
    ...
    override def toJson(differentiator: SerialisationHelper) : org.codehaus.jettison.json.JSONObject = {
        ...
        result.put("Type", "EDM.FPC.MonthAveragePricingSpec@1@1.0")
...
object MonthAveragePricingSpec {
  def version = ModelVersion("1")
  def wireFormatVersion = ModelVersion("1.0")

  
        val jsonTypeName = "EDM.FPC.MonthAveragePricingSpec"

    def fromJson(jobj : org.codehaus.jettison.json.JSONObject, cache: DeserialisationHelper = new DeserialisationHelper) : com.trafigura.edm.fpc.MonthAveragePricingSpec = {
      val v = TypeHolder(jobj.optString("Type"))

      v.assertModelVersion(version, "com.trafigura.edm.fpc.MonthAveragePricingSpec")
      v.assertWireFormatVersion(wireFormatVersion, "com.trafigura.edm.fpc.MonthAveragePricingSpec")
    ...
    def apply(marketId: Int = 0, qpMonth: org.joda.time.LocalDate = null) = {
      val res = new com.trafigura.edm.fpc.MonthAveragePricingSpec
