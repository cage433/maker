...
trait HedgeRequestHandler {
  /**
   * Indicates to the handler that a set of com.trafigura.edm.fpc.HedgeRequest objects has arrived and is ready to be processed.
   ...
   */
  def onHedgeRequest(props:MessageProperties, objs:List[com.trafigura.edm.fpc.HedgeRequest], resultListener:MessageResultListener)
}
