...
trait PaymentTermsService extends ModelService {
  override def serviceNames = super.serviceNames ++ Seq("PaymentTermsService")
  override def serviceKeys = super.serviceKeys ++ Seq("PaymentTermsService")
