...
trait QuotaHandler {
  /**
   * Indicates to the handler that a set of com.trafigura.tradecapture.internal.refinedmetal.Quota objects has arrived and is ready to be processed.
   ...
   */
  def onQuota(props:MessageProperties, objs:List[com.trafigura.tradecapture.internal.refinedmetal.Quota], resultListener:MessageResultListener)
}
