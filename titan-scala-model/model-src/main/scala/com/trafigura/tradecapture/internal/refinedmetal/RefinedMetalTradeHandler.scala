...
trait RefinedMetalTradeHandler {
  /**
   * Indicates to the handler that a set of com.trafigura.tradecapture.internal.refinedmetal.RefinedMetalTrade objects has arrived and is ready to be processed.
   ...
   */
  def onRefinedMetalTrade(props:MessageProperties, objs:List[com.trafigura.tradecapture.internal.refinedmetal.RefinedMetalTrade], resultListener:MessageResultListener)
}
