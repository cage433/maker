...
trait AmendmentParametersHandler {
  /**
   * Indicates to the handler that a set of com.trafigura.tradecapture.internal.refinedmetal.AmendmentParameters objects has arrived and is ready to be processed.
   ...
   */
  def onAmendmentParameters(props:MessageProperties, objs:List[com.trafigura.tradecapture.internal.refinedmetal.AmendmentParameters], resultListener:MessageResultListener)
}
