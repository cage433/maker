...
trait TradeBlotterQuotaRowHandler {
  /**
   * Indicates to the handler that a set of com.trafigura.tradecapture.internal.refinedmetal.TradeBlotterQuotaRow objects has arrived and is ready to be processed.
   ...
   */
  def onTradeBlotterQuotaRow(props:MessageProperties, objs:List[com.trafigura.tradecapture.internal.refinedmetal.TradeBlotterQuotaRow], resultListener:MessageResultListener)
}
