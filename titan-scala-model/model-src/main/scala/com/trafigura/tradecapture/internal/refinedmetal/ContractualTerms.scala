...
import scala.collection.JavaConversions._
 ...
 class ContractualTerms extends com.trafigura.tradinghub.support.ModelObject  {
...
var refDataBaseId:Int = 0
  ...
  override def equals(o: Any) = o match {
    case r: AnyRef =>
        if (o.isInstanceOf[com.trafigura.tradecapture.internal.refinedmetal.ContractualTerms]) {
            val that = r.asInstanceOf[com.trafigura.tradecapture.internal.refinedmetal.ContractualTerms]
  ...
  override def canEqual(that : Any) = that.isInstanceOf[com.trafigura.tradecapture.internal.refinedmetal.ContractualTerms]
  ...
  override def toString = {
    "{com.trafigura.tradecapture.internal.refinedmetal.ContractualTerms: " + "" + "expired = " + expired + ", " + "guid = " + guid + ", " + "mappingCode = " + mappingCode + ", " + "name = " + name + ", " + "oid = " + oid + ", " + "refDataBaseId = " + refDataBaseId +  "}"
  }
     ...
     def toJson(differentiator: SerialisationHelper) : org.codehaus.jettison.json.JSONObject = {
        ...
        result.put("Type", "TradeCapture.Internal.RefinedMetal.ContractualTerms@1@1.0")
...
object ContractualTerms {
  ...
  def wireFormatVersion = ModelVersion("1.0")
        ...
        val jsonTypeName = "TradeCapture.Internal.RefinedMetal.ContractualTerms"

    def fromJson(jobj : org.codehaus.jettison.json.JSONObject, cache: DeserialisationHelper = new DeserialisationHelper) : com.trafigura.tradecapture.internal.refinedmetal.ContractualTerms = {
      val v = TypeHolder(jobj.optString("Type"))

      v.assertModelVersion(version, "com.trafigura.tradecapture.internal.refinedmetal.ContractualTerms")
      v.assertWireFormatVersion(wireFormatVersion, "com.trafigura.tradecapture.internal.refinedmetal.ContractualTerms")

      
        
            val result = new com.trafigura.tradecapture.internal.refinedmetal.ContractualTerms()
    ...
    def apply(oid: Int = 0, guid: GUID = null, expired: Boolean = false, name: String = null, mappingCode: String = null, refDataBaseId: Int = 0) = {
      val res = new com.trafigura.tradecapture.internal.refinedmetal.ContractualTerms
