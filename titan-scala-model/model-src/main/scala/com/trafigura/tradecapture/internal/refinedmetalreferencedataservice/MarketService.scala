...
trait MarketService extends ModelService {
  override def serviceNames = super.serviceNames ++ Seq("MarketService")
  override def serviceKeys = super.serviceKeys ++ Seq("MarketService")
