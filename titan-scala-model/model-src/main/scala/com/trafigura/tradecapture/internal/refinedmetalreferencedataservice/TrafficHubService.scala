...
trait TrafficHubService extends ModelService {
  override def serviceNames = super.serviceNames ++ Seq("TrafficHubService")
  override def serviceKeys = super.serviceKeys ++ Seq("TrafficHubService")
