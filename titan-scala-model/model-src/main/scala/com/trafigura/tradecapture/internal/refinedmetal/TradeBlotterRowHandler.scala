...
trait TradeBlotterRowHandler {
  /**
   * Indicates to the handler that a set of com.trafigura.tradecapture.internal.refinedmetal.TradeBlotterRow objects has arrived and is ready to be processed.
   ...
   */
  def onTradeBlotterRow(props:MessageProperties, objs:List[com.trafigura.tradecapture.internal.refinedmetal.TradeBlotterRow], resultListener:MessageResultListener)
}
