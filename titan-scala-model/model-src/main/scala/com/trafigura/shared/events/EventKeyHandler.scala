...
trait EventKeyHandler {
  /**
   * Indicates to the handler that a set of com.trafigura.shared.events.EventKey objects has arrived and is ready to be processed.
   ...
   */
  def onEventKey(props:MessageProperties, objs:List[com.trafigura.shared.events.EventKey], resultListener:MessageResultListener)
}
