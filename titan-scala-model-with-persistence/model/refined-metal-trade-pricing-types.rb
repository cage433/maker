...
in_namespace('EDM.FPC') {
  ...
  define('PhysicalHedgeRequest', :extends => 'HedgeRequest') {
    ...
    field 'amount',                   'TradeCapture.Internal.RefinedMetal.Quantity', :optional => true # converted to/from lots by commodity and market using ref-data, use this value for actual calculations etc
  }
  ...
  define('NeptuneHedgeRequest') {
    ...
    field 'amount',                   'TradeCapture.Internal.RefinedMetal.Quantity', :optional => true    
  }
  ...
  define('PricingSpec', :abstract => true) {
    ...
    field 'ordinal',                  :integer
    field 'quantity',                 'TradeCapture.Internal.RefinedMetal.Quantity'
    field 'currency',                 :integer_key, :references => 'TradeCapture.Internal.RefinedMetal.Currency(oid)'
