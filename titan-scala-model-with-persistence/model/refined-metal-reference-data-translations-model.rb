...
in_namespace('TradeMgmt.Internal.RefinedMetal') {
  ...
  define('Translation') {
    ...
    field 'oid', :integer, :identifier => true
    field 'language',               :integer_key, :references => 'TradeMgmt.Internal.RefinedMetal.Language(oid)'
  ...
  define('RichTranslation') {
    field 'reqTranslation',         'TradeMgmt.Internal.RefinedMetal.Translation'
    field 'text',                   :string
  ...
  define('Translations') {
    field 'oid', :integer, :identifier => true
    field 'translatedItems',        :list, :element_type => 'TradeMgmt.Internal.RefinedMetal.Translation'
    field 'reqTranslations',        :list, :element_type => 'TradeMgmt.Internal.RefinedMetal.Translation'
  }
}
