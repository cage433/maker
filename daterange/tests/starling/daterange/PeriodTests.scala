...
class PeriodTests extends TestNGSuite {
  ...
  def data1 = {
    constructArgs(
      ...
      ("h2-10", new HalfYear(2010, FrontOrBack.Back)),
      ("1h-10", new HalfYear(2010, FrontOrBack.Front)),
      ("h110", new HalfYear(2010, FrontOrBack.Front)),
      ("1h10", new HalfYear(2010, FrontOrBack.Front)),
      ("1h2010", new HalfYear(2010, FrontOrBack.Front)),
      ("q4-89", Quarter(1989, 4)),
      ("Q1 11", Quarter(2011, 1)),
      ("Q111", Quarter(2011, 1)),
      ("Q1-11", Quarter(2011, 1)),
      ("11q1", Quarter(2011, 1)),
      ("Y09", Year(2009)),
